...
#        self.uhd_usrp_source_0.set_time_unknown_pps(uhd.time_spec(0))
        ...
        self.spread_rx_synthesizer_0 = spread.rx_synthesizer(32000, 64, samp_rate, 12000, 50e3, 0.4, generator, init)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/output.dat', False)
        ...
        # Connections
        ##################################################
        self.connect((self.spread_cpfsk_demod_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.spread_rx_synthesizer_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.spread_rx_synthesizer_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(500e6, self.samp_rate)
