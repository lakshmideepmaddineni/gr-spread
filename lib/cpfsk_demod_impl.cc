...
cpfsk_demod::sptr cpfsk_demod::make(const int samples_per_symbol)
{
    return gnuradio::make_block_sptr<cpfsk_demod_impl>(samples_per_symbol);
}
...
int cpfsk_demod_impl::work(int noutput_items,
