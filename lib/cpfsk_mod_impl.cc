...
cpfsk_mod::sptr cpfsk_mod::make(const int samples_per_symbol)
{
    return gnuradio::make_block_sptr<cpfsk_mod_impl>(samples_per_symbol);
}
...
int cpfsk_mod_impl::work(int noutput_items,
